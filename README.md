...
Projeto desenvolvido em Python para identificar os principais fatores relacionados ao cancelamento de clientes e propor ações para reduzir a taxa de churn.
